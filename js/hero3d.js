...
/* =========================================================
   SERVICE SECTION 3D FULL-PAGE BACKGROUND LINES (첫 번째 선만 오른쪽 아래로 이동)
========================================================= */
export function initServiceLines3D(containerId) {
  ...
  // 첫 번째 요소(인덱스 0)만 오른쪽 아래로 이동시키고, 나머지는 기존 원래 위치 유지
  const lineConfigs = isMobile ? [
    { pos: [ 3.0, -1.0, -2.0], rot: [0.2, 0.4, -0.3], scale: [0.5, 16.0, 0.5], speed: 0.5, offset: 0.0 }, // 이동된 첫 번째 선
    ...
    { pos: [ 8.5, -2.0, -3.0], rot: [0.2, 0.4, -0.3], scale: [0.5, 22.0, 0.5], speed: 0.5, offset: 0.0 }, // 이동된 첫 번째 선
